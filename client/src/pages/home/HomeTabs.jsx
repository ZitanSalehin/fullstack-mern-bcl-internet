...
export default function HomeTabs({
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      <h1 className="text-5xl font-bold tracking-tight text-[#2e2c2c] text-center mb-2">
        What are You Looking For?
      </h1>
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-3/5 mx-auto py-12">
          {/* Tabs */}
          ...
          {activeTab === "packages" && (
            <div className="px-5 lg:px-0">
              <div className="container mx-auto lg:px-12 flex flex-col md:flex-row gap-6 mb-8 items-start">
                {/* Price Slider */}
                <div
          ...
          {/* ---------------- RECONNECTION TAB ---------------- */}
          {activeTab === "queries" && <ReconnectionForm />}
        </div>
