  ...
  return (
    <div className="container mx-auto px-4 py-6 lg:py-10">
      <div className="flex flex-col lg:flex-row justify-between">
        {/* LEFT SECTION */}
        <div className="w-full flex flex-col items-center gap-5 justify-center mx-auto text-center px-4">
          <p className="text-slate-700 font-semibold text-xl sm:text-2xl nato pb-4">
            Are you receiving what you are paid for?
          </p>
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-56 h-56 text-[#00719c]"
          >
          ...
          <Link to="speed-check">
            <button className="flex justify-center cursor-pointer bg-[#00719c] py-2 px-5 rounded-3xl text-lg sm:text-2xl text-white mt-2">
              Click here
            </button>
          </Link>
          ...
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold leading-snug">
            How fast is your{" "}
            <span className="text-[#00719c]">internet right now?</span>
          </h3>
        </div>
